...
void IP_SSATaucForwardProblem::apply_jacobian_design(IceModelVec2V &u,
  ...
  const IceModelVec2Int *dirichlet_locations = m_bc_mask;
  const IceModelVec2V   *dirichlet_values    = m_bc_values;
  double                 dirichlet_weight    = m_dirichlet_scale;
  ...
  fem::DirichletData_Vector dirichletBC(dirichlet_locations, dirichlet_values,
                                        dirichlet_weight);
...
void IP_SSATaucForwardProblem::apply_linearization_transpose(IceModelVec2V &du,
  ...
  fem::DirichletData_Vector dirichletBC(dirichlet_locations, dirichlet_values, dirichlet_weight);
